...
# AMASHI CHECK AND EDIT THIS FILE FOR ME IF I GET SOME ERRORS IDK
...
class Moderation(commands.Cog):
    ...
    @commands.command(aliases = ['ban'], brief = 'Bans the user', description = 'Bans the user from this server')
    ...
    @commands.command(aliases = ['kick'], brief = "Kicks the user", description = "Kicks the user from this server")
    ...
    @commands.command(aliases = ['clear'], brief = 'Deletes messages', decription = 'Deletes messages in bulk')
